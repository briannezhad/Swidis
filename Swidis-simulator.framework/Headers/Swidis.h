...
//  Swidis
//
//  Created by Vilvas, Inc. on 8/14/15.
//  Copyright © 2015 Vilvas, Inc. (Farhad Saadatpei). All rights reserved.
//

#import <UIKit/UIKit.h>

//! Project version number for Swidis.
FOUNDATION_EXPORT double SwidisVersionNumber;

//! Project version string for Swidis.
FOUNDATION_EXPORT const unsigned char SwidisVersionString[];

// In this header, you should import all the public headers of your framework using statements like #import <Swidis/PublicHeader.h>
